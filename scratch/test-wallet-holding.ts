import { db, holdBookingPayment, releaseBookingPayment, refundBookingPayment, getUserBalances } from '../WasilaADK/src/firebase';
...
async function runTest() {
  ...
  try {
    ...
    console.log("Step 2: Placing Rs. 1,500 booking payment in Escrow hold...");
    await holdBookingPayment(testUserId, testBookingId, 1500, testProviderId, "Test Escrow Provider");
    ...
    await releaseBookingPayment(testUserId, testBookingId, 1500, testProviderId, "Test Escrow Provider");
    ...
    const secondBookingId = 'test-booking-2-' + Date.now();
    console.log("Step 4: Setting up a second booking of Rs. 1,000...");
    await holdBookingPayment(testUserId, secondBookingId, 1000, testProviderId, "Test Escrow Provider");
